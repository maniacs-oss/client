...
func setupTest(t *testing.T, numUsers int) (*kbtest.ChatMockWorld, chat1.RemoteInterface, Sender, Sender, *chatListener, kbtest.TlfMock) {
	...
	baseSender := NewBlockingSender(tc.G, boxer, nil, func() chat1.RemoteInterface { return ri })
	...
	tc.G.ConvSource = NewHybridConversationSource(tc.G, boxer, storage.New(tc.G),
		func() chat1.RemoteInterface { return ri })
	tc.G.InboxSource = NewHybridInboxSource(tc.G,
		func() chat1.RemoteInterface { return ri }, tlf)
